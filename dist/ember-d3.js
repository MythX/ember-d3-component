...
Ember.Chart.ChartComponent = Ember.Component.extend({
  ...
  draw: function() {
    ...
    var test = formatedDatas.map(function(d, i) { return  'bar'+i ; });
    console.log("e", test);
    ...
    /*for(var i = 0; i < formatedDatas.length; i++) {
      if (types[i] === 'line') {
        ...
        this.drawBarChart(x, x1, y, formatedDatas[i], test);
      }
    }*/
    this.drawBarChart(x, x1, y, formatedDatas, test);
  },
  ...
  drawBarChart: function(x, x1, y, data, test) {
    ...
    state.selectAll("rect")
        .data(function (d) { console.log(d.valD); return d.valD; })
      .enter().append("rect")
        .attr("width", x1.rangeBand())
        .attr("x", function(d) { return x1("bar0"); })
