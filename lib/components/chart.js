...
Ember.Chart.ChartComponent = Ember.Component.extend({
  ...
  draw: function(redraw) {
    ...
    areaCharts.forEach(function(a) {
      var area = this.drawArea(x, this.searchYAxis(a.yAxis, yAxisArray), a.defined);
      path = this.drawAreaOnSvg(area, a.data, a.color);
      var line = this.drawLine(x, this.searchYAxis(a.yAxis, yAxisArray), a.data, a.interpolate, xAxis.origin, area);
  ...
  drawArea: function(x, y, defined) {
    var area = d3.svg.area()
      ...
      .y0(this.height)
      .y1(function(d) { console.log('voici d = ' + d); return y(d.valD); });
